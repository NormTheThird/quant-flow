...
namespace QuantFlow.Data.SQLServer.Migrations
{
    ...
    [Migration("20251023003449_AddAlgorithmAndEffectivenessTables")]
    partial class AddAlgorithmAndEffectivenessTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuantFlow.Data.SQLServer.Models.AlgorithmEffectivenessEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<decimal?>("AverageMaxDrawdown")
                        .HasPrecision(5, 4)
                        .HasColumnType("decimal(5,4)");

                    b.Property<decimal?>("AverageReturnPerTrade")
                        .HasPrecision(6, 4)
                        .HasColumnType("decimal(6,4)");

                    b.Property<decimal?>("AverageSharpeRatio")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("AverageStopLossPercent")
                        .HasPrecision(5, 4)
                        .HasColumnType("decimal(5,4)");

                    b.Property<int?>("AverageTradesPerMonth")
                        .HasColumnType("int");

                    b.Property<decimal?>("AverageWinRate")
                        .HasPrecision(5, 4)
                        .HasColumnType("decimal(5,4)");

                    b.Property<string>("AvoidWhen")
                    ...
                    b.Property<int>("OpportunityStars")
                        .HasColumnType("int");

                    b.Property<int>("RecommendedStars")
                        .HasColumnType("int");

                    b.Property<string>("ReliabilityReason")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<int>("ReliabilityStars")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TotalBacktestsRun")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RecommendedStars")
                        .HasDatabaseName("IX_AlgorithmEffectiveness_RecommendedStars");

                    b.HasIndex("AlgorithmId", "Timeframe")
                        .IsUnique()
                        .HasDatabaseName("IX_AlgorithmEffectiveness_AlgorithmId_Timeframe")
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("AlgorithmEffectiveness");
                });

            modelBuilder.Entity("QuantFlow.Data.SQLServer.Models.AlgorithmEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("AlgorithmSource")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuantFlow.Data.SQLServer.Models.BacktestRunEntity", b =>
                {
                    ...
                    b.Property<string>("AlgorithmParameters")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("AverageTradeReturnPercent")
                        .HasPrecision(8, 4)
                        .HasColumnType("decimal(8,4)");

                    b.Property<DateTime>("BacktestEndDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("BacktestStartDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("QuantFlow.Data.SQLServer.Models.PortfolioEntity", b =>
                {
                    ...
                    b.Property<Guid?>("UserExchangeDetailsId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserExchangeDetailsId");
            ...
            modelBuilder.Entity("QuantFlow.Data.SQLServer.Models.TradeEntity", b =>
                {
                    ...
                    b.Property<Guid?>("BacktestRunEntityId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BacktestRunEntityId");
            ...
            modelBuilder.Entity("QuantFlow.Data.SQLServer.Models.AlgorithmEffectivenessEntity", b =>
                {
                    b.HasOne("QuantFlow.Data.SQLServer.Models.AlgorithmEntity", "Algorithm")
                        .WithMany()
            ...
            modelBuilder.Entity("QuantFlow.Data.SQLServer.Models.PortfolioEntity", b =>
                {
                    ...
                    b.Navigation("UserExchangeDetails");
                });
            ...
            modelBuilder.Entity("QuantFlow.Data.SQLServer.Models.TradeEntity", b =>
                {
                    ...
                    b.HasOne("QuantFlow.Data.SQLServer.Models.BacktestRunEntity", null)
                        .WithMany("Trades")
                        .HasForeignKey("BacktestRunEntityId");
