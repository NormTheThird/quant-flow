...
public static class BacktestRunModelFixture
{
    ...
    /// </summary>
    public static BacktestRunModel CreateCustomBacktestRun(Guid userId, Guid portfolioId, string name, string symbol = "BTCUSDT", Exchange exchange = Exchange.Binance,
