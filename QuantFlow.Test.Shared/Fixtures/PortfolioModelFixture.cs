...
public static class PortfolioModelFixture
{
    ...
    /// <summary>
    /// Creates a suspended portfolio model for testing
    /// </summary>
    public static PortfolioModel CreateSuspendedPortfolio(Guid? userId = null, string name = "Suspended Portfolio")
    {
        return new PortfolioModel
        {
            Id = Guid.NewGuid(),
            Name = name,
            Description = "A portfolio that has been suspended due to issues",
            InitialBalance = 8000.0m,
            CurrentBalance = 7800.0m,
